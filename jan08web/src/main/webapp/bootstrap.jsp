...
<body id="page-top">
	...
	<section>
		...
		<div class="mx-5 p-5 border-top border-bottom">
				...
				<tbody>
					<c:forEach items="${list }" var="row">
						<tr class="row">
							...
							<td class="col-5">${row.title }</td>
							<td class="col-2">${row.write }</td>
							<td class="col-2">${row.date }</td>
							<td class="col-2">${row.count }</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
		...
		<div class="container bg-info text-white">
			구역
			<div class="m-5 mb-0 bg-primary bg">구역2</div>
	...
	<footer class="bg-black text-center py-5">
		<div class="container px-5">
			<div class="text-white-50 small">
				<div class="mb-2">&copy; poseidon 2024. All Rights Reserved.</div>
