		   ...
		   $.ajax({
			   ...
			   success : function(result){//성공시
				   ...
				   if(result==1){
					   ...
					   idCheckBool = true;
					   $("#joinBtn").removeAttr("disabled");//활성화 시키기
					   //$('#name').focus();
				   }
			   },
		...
		<div class="main">
			<div class="mainStyle">
				<article>
					...
					<div class="join-form">
						<h1>회원가입</h1>
						<div class="mx-3 p-3 bg-info rounded">
							<form action="./join" method="post" onsubmit="return check()">
								...
								<div class="input-group mb-2">
									<label class="input-group-text">암&ensp;&ensp;호</label>
									<input type="password" id="pw1" name="pw1" class="form-control" placeholder="암호를 입력하세요">
									<label class="input-group-text">재입력</label>
									<input type="password" id="pw2" name="pw2" class="form-control" placeholder="한번 더 입력하세요">
								</div>
